...
<!-------------------------------------------HERO SECTION------------------------------------------------>
    ...
    <div class="section">
      ...
      <div class="fullpage-main-block indicator"  data-back-type='image'  data-image="/img/hero_anarbekovi/anarbekovi_7.jpg">
        <div class="fullpage-main-block__overlay"></div>
        <p class="fullpage-main-block__text">
          Уже на протяжении 4 лет мы работаем с благотворительным фондом BEST FOR KIDS: учим воспитанников детского дома танцам. Хотим передать им свою философию – «никогда не сдаваться».
        </p>
